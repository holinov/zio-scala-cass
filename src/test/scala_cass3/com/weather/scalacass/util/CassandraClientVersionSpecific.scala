...
trait CassandraClientVersionSpecific {
  def clusterStartup(cb: Cluster.Builder): Cluster.Builder = {
    ...
    registry.register(
      codecs.jdk8.InstantCodec.instance,
      codecs.jdk8.LocalDateCodec.instance,
      codecs.jdk8.LocalTimeCodec.instance,
      codecs.joda.InstantCodec.instance,
      codecs.joda.LocalDateCodec.instance,
